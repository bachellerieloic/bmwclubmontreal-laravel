	...
	<div>
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Sorties</h3>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Ajouter une sortie</h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Filtrer les sorties</h4>
    ...
    export default {
        ...
        methods: {
            getSorties(page) {
                ...
                axios.get('/api/sorties?page=' + page + url)
