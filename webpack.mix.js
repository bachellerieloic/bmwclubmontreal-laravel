...
mix.js('resources/assets/js/app.js', 'public/js/app.js')
  .combine([
    ...
    plugin + 'datatables.net/jquery.dataTables.min.js',
    plugin + 'datatables.net-bs4/dataTables.bootstrap4.min.js',
    plugin + 'datatables.net-buttons/buttons.flash.min.js',
    plugin + 'datatables.net-buttons/buttons.html5.min.js',
    plugin + 'datatables.net-buttons/buttons.print.min.js',
    plugin + 'datatables.net-buttons/dataTables.buttons.min.js',
    plugin + 'datatables.net-buttons-bs4/buttons.bootstrap4.min.js',
    plugin + 'datatables.net-select/dataTables.select.min.js',
