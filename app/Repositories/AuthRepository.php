...
class AuthRepository
{
    ...
    public function check()
    {
        ...
        \Cache::put('direction', (\Auth::user()->UserPreference->direction === 'rtl' ? 'rtl' : 'ltr'), config('jwt.ttl') * 60);
        \Cache::put('locale',\Auth::user()->UserPreference->locale, config('jwt.ttl') * 60);
